...
class ConfigManager {
    ...
    async updateLocally(config) {
        ...
        console.log('Configuration would be updated locally:', config);
    }
        ...
        try {
            ...
            const progressNotification = window.adminApp?.notificationManager?.showProgress(
                ...
                { 
                    title: 'Processando',
                    cancellable: true,
                    onCancel: () => console.log('Operação cancelada pelo usuário')
                }
            );
                        ...
                        actions: [
                            {
                                label: 'Ver Detalhes',
                                handler: () => {
                                    console.log('Mostrando detalhes da configuração');
                                }
                            }
                        ]
                    }
            ...
            console.log('Error caught in demonstrateErrorHandling:', error.message);
