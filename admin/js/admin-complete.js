...
class AdminPanelApp {
    constructor() {
        ...
        console.log('AdminPanelApp initialized');
    }
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing complete admin app...');
    ...
    console.log('Complete admin app initialized and available globally');
});